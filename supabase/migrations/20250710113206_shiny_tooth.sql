/*
# Create ML/NLP Tables for AI Features

1. New Tables
   - `ml_insights` - Store ML analysis insights and metrics
   - `anomalies` - Track detected anomalies and security issues  
   - `user_activity_logs` - Log user interactions for ML analysis
   - `search_queries` - Store search queries for NLP processing

2. File Table Updates
   - Add AI-related columns to existing files table
   - Add columns for AI tags, summaries, classifications, keywords
   - Add sentiment analysis and processing status tracking

3. Security
   - Enable RLS on all new tables
   - Add appropriate policies for data access
   - Create helper functions for logging and insights

4. Performance
   - Add indexes for efficient querying
   - Optimize for ML/NLP workloads
*/
